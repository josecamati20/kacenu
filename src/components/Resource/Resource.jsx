...
function Resource() {
  return (
    <div className='resource' id="resources">
        <img src='/assets/img/illustrations/feature-bg.png' />
        <div className="resources">
            <h4 className="resources-title">Awesome apps features</h4>
             <CardResourse 
            url={'/assets/img/illustrations/fast-performance.png'} 
            ...
            <CardResourse 
            url={'/assets/img/illustrations/prototype.png'} 
            title={"Fast performance"}
            text={"Get your blood tests delivered at home collect a sample from the news your blood tests."}
            color={"#2500F9"}
            />
            ...
            <CardResourse 
            url={'/assets/img/illustrations/vector.png'} 
            title={"Fast performance"}
            text={"Get your blood tests delivered at home collect a sample from the news your blood tests."}
            color={"#40975F"}
            />
